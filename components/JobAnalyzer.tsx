  ...
  return (
    <main className="ja-root">
      ...
      <div className="ja-container">
        ...
        {/* ── Sign-in gate ── */}
        {loading ? (<div className="ja-signin-card">
          <div className="ja-card-header">
            <div className="ja-card-icon-wrap" style={{ background: "rgba(36, 122, 112, 0.15)", color: "#247a70" }}>
              <LoaderIcon className="dashboard-logo-icon animate-spin" />
            </div>
            <div>
              <h2 className="ja-card-title">Loading...</h2>
              <p className="ja-card-subtitle">Please wait while we load your profile.</p>
            </div>
          </div>
        </div>
        ) :
